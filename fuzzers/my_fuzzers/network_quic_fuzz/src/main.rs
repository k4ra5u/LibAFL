...
pub fn main() {
    ...
    first_cpu_usage_observer.add_cpu_id(50);
    first_cpu_usage_observer.add_cpu_id(51);
    ...
    second_cpu_usage_observer.add_cpu_id(52);
    second_cpu_usage_observer.add_cpu_id(53);
