...
pub fn ping(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let mtu_probe = Some(buf_to_u64(buf)? as usize);
...
pub fn ack(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let ranges_num = buf_to_u8(buf)?; 
    for _ in 0..ranges_num {
        let start = buf_to_u64(buf)?;
        let end = buf_to_u64(buf)?;
        ranges.insert(start..end);
    }
    let frame = frame::Frame::ACK {
        ack_delay: buf_to_u64(buf)?,
        ranges,
        ecn_counts: None,
    };
    Ok(frame)
...
pub fn ack_ecn(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let ecn_counts = Some(EcnCounts {
        ect0_count: buf_to_u64(buf)?,
        ect1_count: buf_to_u64(buf)?,
        ecn_ce_count: buf_to_u64(buf)?,
    });
...
pub fn reset_stream(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let frame = frame::Frame::ResetStream {
        stream_id: buf_to_u64(buf)?,
        error_code: buf_to_u64(buf)?,
        final_size: buf_to_u64(buf)?,
    };
    Ok(frame)
}
...
pub fn max_data(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let frame = frame::Frame::MaxData { max: buf_to_u64(buf)? };
    Ok(frame)
}
...
pub fn max_streams_bidi(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let frame = frame::Frame::MaxStreamsBidi { max: buf_to_u64(buf)? };
    Ok(frame)
}
...
pub fn max_streams_uni(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let frame = frame::Frame::MaxStreamsUni { max: buf_to_u64(buf)? };
    Ok(frame)
}
...
pub fn data_blocked(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let frame = frame::Frame::DataBlocked { limit: buf_to_u64(buf)? };
    Ok(frame)
}
...
pub fn streams_blocked_bidi(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let frame = frame::Frame::StreamsBlockedBidi { limit: buf_to_u64(buf)? };
    Ok(frame)
}
...
pub fn streams_blocked_uni(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let frame = frame::Frame::StreamsBlockedUni { limit: buf_to_u64(buf)? };
    Ok(frame)
}
...
pub fn new_connection_id(buf: &mut &[u8], len: usize) -> Result<frame::Frame, Error> {
    ...
    let seq_num = buf_to_u64(buf)?;
    let retire_prior_to = buf_to_u64(buf)?;

    let conn_id_len = buf_to_u8(buf)? as usize;    
...
pub fn retire_connection_id(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let frame = frame::Frame::RetireConnectionId { seq_num: buf_to_u64(buf)? };
    Ok(frame)
}
...
pub fn connection_close(buf: &mut &[u8],len:usize) -> Result<frame::Frame, Error> {
    ...
    let error_code = buf_to_u64(buf)?;
    let frame_type = buf_to_u64(buf)?;
